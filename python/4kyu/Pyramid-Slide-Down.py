...
def longest_slide_down(pyramid):
    ...
    bottom_layer = pyramid[-1]
    working_layer = []
    for i in range(1, len(bottom_layer)):
        working_layer.append(max(bottom_layer[i], bottom_layer[i-1]))

    pyramid[-2] = [a+b for a, b in zip(pyramid[-2], working_layer)]
